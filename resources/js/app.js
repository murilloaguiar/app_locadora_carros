...
Vue.filter ('formataDataTempoGlobal', function(data){
    if (!data) return '' 
            ...
            let dataDMA = data[0]
            dataDMA = dataDMA.split('-')
            //d/m/a
            dataDMA = dataDMA[2] + '/' + dataDMA[1] + '/' + dataDMA[0]
            ...
            return dataDMA + ' ' + tempo
})

const app = new Vue({
    el: '#app',
    store //indicando uma instância do vuex com os atributos que serão globais
});
